...
key = 'help_theme_no_4_1_1_2'

async def commandHelpThemeNo4_1_1_2(event, answer):
    chat = event.chat_id
    ...
    markup = [[Button.inline(f"Да", f'help_theme_no_4_1_1_3:1'.encode())], [Button.inline(f"Нет", f'help_theme_no_4_1_1_3:2'.encode())]]
